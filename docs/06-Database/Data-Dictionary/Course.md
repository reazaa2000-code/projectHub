...
| DefaultSessionCount | int | No | | Course | Default/template number of Sessions used when creating a Class |
...
- DurationHours must be greater than zero.
- DefaultSessionCount must be greater than zero.
